  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <Button variant="none" className="border-0 ring-offset-0 focus-visible:outline-none focus-visible:ring-0  focus-visible:ring-offset-0">
          ...
          <React.Fragment key={item.href}>
            ...
            <DropdownMenuItem asChild>
              <Link to={item.href} className={`flex items-center cursor-pointer ${item.className || ""}`}>
                {item.icon && <item.icon className="mr-2 h-4 w-4 text-emerald-400" />}
                <div className="">
