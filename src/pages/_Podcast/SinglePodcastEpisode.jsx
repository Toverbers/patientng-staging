        ...
        <div className="space-y-8">
          ...
          <div className="flex gap-6">
            <img
              ...
              className="w-20 h-20 md:w-48 md:h-48 rounded-lg object-cover"
            />
            <div className="flex-1">
              <div className="flex items-center gap-4 text-gray-500 mb-2">
                ...
                {/* <span>•</span>
                <span>{singlePodcast?.duration}</span> */}
              </div>
          ...
          <div className="text-gray-600">
            <p className="mb-2">
              We publish a newsletter every Week. Short essays, suggestions, and information on additional ways to engage with the show are all included. Register at{' '}
              <a href="https/patient.ng/signup" className="text-emerald-500 hover:underline">patient.ng</a>.
            </p>
            <p>
              Follow us on social media at on{' '}
              <a href="https://www.instagram.com/patientdotng?igsh=eGgxbWN4Z3ZhaHZn&utm_source=qr" target="_blank" className="text-emerald-500 hover:underline">Instagram</a>,{' '}
              <a href="https://x.com/patientdotng?s=11&t=WDXKro3kSag6ImoNjJ85tw" target="_blank" className="text-emerald-500 hover:underline">Twitter</a>, and{' '}
              <a href="https://www.facebook.com/profile.php?id=61563453420792&mibextid=LQQJ4d&_rdc=2&_rdr" target="_blank" className="text-emerald-500 hover:underline">Facebook</a>,
              and send us your feedback at www.patient.ng
            </p>
          </div>
        </div>
      </div>
